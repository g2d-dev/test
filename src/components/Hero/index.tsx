            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-2xl font-bold leading-snug text-white sm:text-3xl sm:leading-snug lg:text-4xl lg:leading-[1.2]">
                  Propulsez vos processus avec des solutions numériques sur
                  mesure, adaptées à vos ambitions !
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Transformez vos défis en opportunités numériques. Nous aidons
                  les entreprises camerounaises à optimiser leurs processus
                  grâce à des solutions innovantes, performantes et adaptées à
                  leurs besoins. Découvrez comment le numérique peut
                  révolutionner votre activité.
                </p>

                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Qu&apos;attendez-vous pour propulser votre entreprise vers
                    de nouvelles hauteurs ?
                  </p>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    Quelques technologies que nous utilisons :
                  </p>
                  <div
